...
async def convert_video(video_file, output_directory, total_time, bot, message, chan_msg):
    ...
    aa = kk.split(".")[-1]
    out_put_file_name = kk.replace(f".{aa}", "[@anime_spectrum].mkv")
    ...
    audio_b.append("40k")
    watermark.append('-vf "drawtext=fontfile=font.ttf:fontsize=16:fontcolor=white:bordercolor=black@0.50:x=w-tw-10:y=10:box=1:boxcolor=black@0.5:boxborderw=6:text=@Anime_encodes_30mb"')
